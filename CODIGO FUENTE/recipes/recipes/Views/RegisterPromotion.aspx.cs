    ...
    {   
        ...
        protected void btn_createPromotion_Click(object sender, EventArgs e)
        {
            if (checkFields())
            {
                ...
                flpImage1.PostedFile.SaveAs(Server.MapPath("~/Images/RecipePhotos/") + strname);
                strname = "~/Images/RecipePhotos/" + strname;
                //if (flpImage2.HasFile)
                //{
                //    strname2 = flpImage2.FileName.ToString();
                //    strname2 = DateTime.Now.ToString("dd.MM.yyyy.hh.mm.ss.ffffff") + strname2;
                //    flpImage2.PostedFile.SaveAs(Server.MapPath("~/Images/RecipePhotos/") + strname2);
