<%@ Page Title="" Language="C#" MasterPageFile="~/Views/recipesHTT.Master" AutoEventWireup="true" CodeBehind="AboutUsAdmin.aspx.cs" Inherits="recipes.Views.AboutUsAdmin" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        ...
                        <div class="md-form">
                            <label id="inicio" style="display:none" runat="server"></label>
                    ...
                    <div class="block">
                        ...
                        <div>
                            <asp:image ID="imageIni" runat="server" Width="40%" Height="30%"/>
                        </div>
                        <div>
                            <asp:Button type="button" ID="btnSave" runat="server" class="btn btn-success" OnClick="btnSave_Click" Text="Guardar"/>
                        </div>
