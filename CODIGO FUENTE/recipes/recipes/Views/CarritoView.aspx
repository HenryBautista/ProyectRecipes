        ...
        <div style="float: left; width: 70%;" class="detail">
            <table>
                ...
                <tr>
                    ...
                    <td class="text">
                        <asp:Label CssClass="detalle" ID="lbl_cantidad" placeholder="Nombre ingrediente" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="label">Precio Total:</td>
                    <td class="text">
                        <asp:Label class="detalle" ID="lbl_cost" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="text">                        
