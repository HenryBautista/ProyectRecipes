<%@ Page Title="" Language="C#" MasterPageFile="~/Views/recipesHTT.Master" AutoEventWireup="true" CodeBehind="RegisterRecipe.aspx.cs" Inherits="recipes.Views.RegisterRecipe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="about-us">
        <div style="width: 90%; height: auto; margin-left: auto; margin-right: auto;">
            <h3>Lista de<span> Recetas</span></h3>
            <hr />
            <div>
